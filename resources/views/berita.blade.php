                ...
                <div class="card-body">
                    ...
                    <h6>Writen By :
                        <a class="text-decoration-none fw-bolder"
                            href="/author/{{ $berita[0]->author->username }}">{{ $berita[0]->author->name }}</a> in <a
                            class="text-decoration-none badge bg-primary"
                            href="/category/{{ $berita[0]->category->slug }}">{{ $berita[0]->category->name }}</a>
                ...
                <div class="col-lg-4">
                    <div class="card mb-3">
                        <img src="https://source.unsplash.com/500x400/?{{ $post->category->name }}" class="card-img-top"
                            alt="img-source">
                        <div class="position-absolute px-3 py-2 bg-trans"><a class="text-white text-decoration-none fw-bold"
                                href="/category/{{ $post->category->slug }}">{{ $post->category->name }}</a></div>
                        <div class="card-body">
